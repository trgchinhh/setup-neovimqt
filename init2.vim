...
"autocmd ColorScheme * highlight CocMenuLabel guifg=#ffffff guibg=NONE
...
require('lualine').setup {
  ...
  sections = {
    ...
    lualine_c = {
      {
        ...
        color = { fg = '#ffffff', bg = nil }, -- #3E4452 #373737 -- chữ trắng, nền xanh đậm
        separator = { right = '' },
      }
    },
    ...
    lualine_y = {
      ...
      {
        function() return '' end,
        color = { fg = nil, bg = nil },  -- fg = nền UTF-8, bg = nền bên trái
        padding = { left = 0, right = 0 },
      },
      -- Phần encoding + fileformat
      {
        ...
        color = { fg = nil, bg = nil }, -- nền của UTF-8
        separator = '',
      },
    },
...
hi FloatermBorder guifg=White guibg=#1abc9a gui = bold

"hi Floaterm guibg=Grey15
"hi FloatermBorder guifg=Orange guibg=DarkGreen gui=bold
